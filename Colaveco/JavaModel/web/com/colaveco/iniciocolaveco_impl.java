...
public final  class iniciocolaveco_impl extends GXDataArea
{
   public iniciocolaveco_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public iniciocolaveco_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( iniciocolaveco_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2023126152455", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.colaveco.iniciocolaveco", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.colaveco.iniciocolaveco", new String[] {}, new String[] {})  ;
   }

   public String getPgmname( )
   {
      return "InicioColaveco" ;
   }
   ...
   public void wb150( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         ClassString = "Button" ;
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttSalir_Internalname, "", "Salir", bttSalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SALIR\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_InicioColaveco.htm");
   ...
   public void start152( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Inicio Colaveco", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20231261524814", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("iniciocolaveco.js", "?20231261524828", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Inicio Colaveco" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'SALIR'","{handler:'e11152',iparms:[]");
