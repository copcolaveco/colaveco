...
public final  class viewnotificaciones_impl extends GXDataArea
{
   public viewnotificaciones_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewnotificaciones_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewnotificaciones_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV12NotificacionesId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12NotificacionesId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12NotificacionesId), 18, 0));
            com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vNOTIFICACIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12NotificacionesId), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20231261524246", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.colaveco.viewnotificaciones", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12NotificacionesId,18,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"NotificacionesId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"ViewNotificaciones");
      forbiddenHiddens.add("NotificacionesFecha", localUtil.format( A169NotificacionesFecha, "99/99/99 99:99"));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "hsh", httpContext.getEncryptedSignature( forbiddenHiddens.toString(), GXKey));
      GXutil.writeLogInfo("viewnotificaciones:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vNOTIFICACIONESID", GXutil.ltrim( localUtil.ntoc( AV12NotificacionesId, (byte)(18), (byte)(0), ".", "")));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vNOTIFICACIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12NotificacionesId), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.colaveco.viewnotificaciones", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12NotificacionesId,18,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"NotificacionesId","TabCode"})  ;
   }
   ...
   public void wb0U0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Notificaciones Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_ViewNotificaciones.htm");
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Notificaciones", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, (short)(0), "HLP_ViewNotificaciones.htm");
         ...
         com.colaveco.GxWebStd.gx_single_line_edit( httpContext, edtNotificacionesFecha_Internalname, localUtil.ttoc( A169NotificacionesFecha, 10, 8, 1, 2, "/", ":", " "), localUtil.format( A169NotificacionesFecha, "99/99/99 99:99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNotificacionesFecha_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtNotificacionesFecha_Enabled, 0, "text", "", 17, "chr", 1, "row", 17, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_ViewNotificaciones.htm");
         com.colaveco.GxWebStd.gx_bitmap( httpContext, edtNotificacionesFecha_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtNotificacionesFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewNotificaciones.htm");
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ViewNotificaciones.htm");
         /* Div Control */
   ...
   public void start0U2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Notificaciones", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "ViewNotificaciones" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0U2( )
   {
      ...
      {
         /* Using cursor H000U2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV12NotificacionesId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A6NotificacionesId = H000U2_A6NotificacionesId[0] ;
            A169NotificacionesFecha = H000U2_A169NotificacionesFecha[0] ;
            n169NotificacionesFecha = H000U2_n169NotificacionesFecha[0] ;
   ...
   public void strup0U0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV12NotificacionesId = localUtil.ctol( httpContext.cgiGet( "vNOTIFICACIONESID"), ".", ",") ;
         ...
         {
            GXutil.writeLogError("viewnotificaciones:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e110U2( )
   {
      ...
      AV16GXLvl6 = (byte)(0) ;
      /* Using cursor H000U3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV12NotificacionesId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A6NotificacionesId = H000U3_A6NotificacionesId[0] ;
         A169NotificacionesFecha = H000U3_A169NotificacionesFecha[0] ;
         n169NotificacionesFecha = H000U3_n169NotificacionesFecha[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A169NotificacionesFecha", localUtil.ttoc( A169NotificacionesFecha, 8, 5, 1, 2, "/", ":", " "));
         AV16GXLvl6 = (byte)(1) ;
         Form.setCaption( localUtil.ttoc( A169NotificacionesFecha, 8, 5, 1, 2, "/", ":", " ") );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.colaveco.wwnotificaciones", new String[] {}, new String[] {})  ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV7SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV7SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "NotificacionesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.colaveco.notificacionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "NotificacionesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0030","",Long.valueOf(AV12NotificacionesId)});
   ...
   {
      AV12NotificacionesId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12NotificacionesId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12NotificacionesId), 18, 0));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vNOTIFICACIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12NotificacionesId), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20231261524294", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewnotificaciones.js", "?20231261524294", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View Notificaciones" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12NotificacionesId',fld:'vNOTIFICACIONESID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A169NotificacionesFecha',fld:'NOTIFICACIONESFECHA',pic:'99/99/99 99:99'}]");
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H000U2_A6NotificacionesId = new long[1] ;
      H000U2_A169NotificacionesFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H000U2_n169NotificacionesFecha = new boolean[] {false} ;
      hsh = "" ;
      H000U3_A6NotificacionesId = new long[1] ;
      H000U3_A169NotificacionesFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H000U3_n169NotificacionesFecha = new boolean[] {false} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.viewnotificaciones__default(),
         new Object[] {
             new Object[] {
            H000U2_A6NotificacionesId, H000U2_A169NotificacionesFecha, H000U2_n169NotificacionesFecha
            }
            , new Object[] {
            H000U3_A6NotificacionesId, H000U3_A169NotificacionesFecha, H000U3_n169NotificacionesFecha
            }
         }
      );
      AV15Pgmname = "ViewNotificaciones" ;
   ...
   private int idxLst ;
   private long wcpOAV12NotificacionesId ;
   private long AV12NotificacionesId ;
   ...
   private long[] H000U2_A6NotificacionesId ;
   private java.util.Date[] H000U2_A169NotificacionesFecha ;
   private boolean[] H000U2_n169NotificacionesFecha ;
   private long[] H000U3_A6NotificacionesId ;
   private java.util.Date[] H000U3_A169NotificacionesFecha ;
   private boolean[] H000U3_n169NotificacionesFecha ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewnotificaciones__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000U2", "SELECT `NotificacionesId`, `NotificacionesFecha` FROM `Notificaciones` WHERE `NotificacionesId` = ? ORDER BY `NotificacionesId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H000U3", "SELECT `NotificacionesId`, `NotificacionesFecha` FROM `Notificaciones` WHERE `NotificacionesId` = ? ORDER BY `NotificacionesId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
