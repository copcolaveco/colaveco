...
public final  class wwpublicidadapp_impl extends GXDataArea
{
   public wwpublicidadapp_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpublicidadapp_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpublicidadapp_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20221231166124", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.colaveco.wwpublicidadapp", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.colaveco.wwpublicidadapp", new String[] {}, new String[] {})  ;
   }

   public String getPgmname( )
   {
      return "WWPublicidadApp" ;
   }
   ...
   public void wb0Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Publicidad Apps", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_WWPublicidadApp.htm");
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPublicidadApp.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0Z2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Publicidad Apps", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e120Z2( )
   {
      ...
      AV13Delete = "Delete" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV13Delete);
      Form.setCaption( "Publicidad Apps" );
   ...
   private void e140Z2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      edtavUpdate_Link = formatLink("com.colaveco.publicidadapp", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A183PublicidadId,18,0))}, new String[] {"Mode","PublicidadId"})  ;
      edtavDelete_Link = formatLink("com.colaveco.publicidadapp", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A183PublicidadId,18,0))}, new String[] {"Mode","PublicidadId"})  ;
      edtPublicidadTitulo_Link = formatLink("com.colaveco.viewpublicidadapp", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A183PublicidadId,18,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"PublicidadId","TabCode"})  ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(25) ;
   ...
   public void e110Z2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.colaveco.publicidadapp", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","PublicidadId"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV9TrnContext.setgxTv_SdtTransactionContext_Transactionname( "PublicidadApp" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202212311661313", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwpublicidadapp.js", "?202212311661313", false, true);
      }
   ...
   public void initialize( )
   {
      ...
      sImgUrl = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.wwpublicidadapp__default(),
         new Object[] {
             new Object[] {
            H000Z2_A191PublicidadMostrarWeb, H000Z2_A190PublicidadMostrarApp, H000Z2_A189PublicidadMenuWeb, H000Z2_A188PublicidadMenuApp, H000Z2_A187PublicidadImagen, H000Z2_A40000PublicidadImagen_GXI, H000Z2_A186PublicidadDescripcion, H000Z2_A185PublicidadSubTitulo, H000Z2_A184PublicidadTitulo, H000Z2_A183PublicidadId
            }
            , new Object[] {
...
final  class wwpublicidadapp__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A184PublicidadTitulo )
   {
      ...
      sFromString = " FROM `PublicidadApp`" ;
      sOrderString = "" ;
                                          ...
                                          String A184PublicidadTitulo )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM `PublicidadApp`" ;
      if ( ! (GXutil.strcmp("", AV11PublicidadTitulo)==0) )
      {
         addWhere(sWhereString, "(`PublicidadTitulo` like ?)");
      }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[6])[0] = rslt.getString(7, 256);
