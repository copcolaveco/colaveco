...
public final  class publicidadapp_impl extends GXDataArea
{
   public void initenv( )
   {
      if ( GxWebError != 0 )
   ...
   public void inittrn( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Publicidad App", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public publicidadapp_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public publicidadapp_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( publicidadapp_impl.class ));
   }
   ...
   public void drawControls( )
   {
      ...
      /* Text block */
      com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblTitle_Internalname, "Publicidad App", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, (short)(0), "HLP_PublicidadApp.htm");
      ...
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_first_Internalname, "", "", bttBtn_first_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_first_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"EFIRST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_previous_Internalname, "", "", bttBtn_previous_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_previous_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"EPREVIOUS."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      ClassString = "BtnNext" ;
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_next_Internalname, "", "", bttBtn_next_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_next_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ENEXT."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      ClassString = "BtnLast" ;
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_last_Internalname, "", "", bttBtn_last_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_last_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ELAST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_select_Internalname, "", "Select", bttBtn_select_Jsonclick, 5, "Select", "", StyleString, ClassString, bttBtn_select_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "", 2, "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      com.colaveco.GxWebStd.gx_single_line_edit( httpContext, edtPublicidadId_Internalname, GXutil.ltrim( localUtil.ntoc( A183PublicidadId, (byte)(18), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A183PublicidadId), "ZZZZZZZZZZZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPublicidadId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPublicidadId_Enabled, 1, "text", "1", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "id", "right", false, "", "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_enter_Internalname, "", "Confirm", bttBtn_enter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtn_delete_Internalname, "", "Delete", bttBtn_delete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PublicidadApp.htm");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void standaloneStartupServer( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( localUtil.ctol( httpContext.cgiGet( edtPublicidadId_Internalname), ".", ",") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtPublicidadId_Internalname), ".", ",") > 999999999999999999L ) ) )
            {
               httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_badnum"), 1, "PUBLICIDADID");
               AnyError = (short)(1) ;
               GX_FocusControl = edtPublicidadId_Internalname ;
               httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true ;
            ...
            publicidadapp_impl.this.A187PublicidadImagen = GXv_char1[0] ;
            publicidadapp_impl.this.A40000PublicidadImagen_GXI = GXv_char2[0] ;
            GXKey = httpContext.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
            forbiddenHiddens = new com.genexus.util.GXProperties() ;
            forbiddenHiddens.add("hshsalt", "hsh"+"PublicidadApp");
            ...
            {
               GXutil.writeLogError("publicidadapp:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
               GxWebError = (byte)(1) ;
   ...
   public void e12082( )
   {
      ...
      {
         callWebObject(formatLink("com.colaveco.wwpublicidadapp", new String[] {}, new String[] {}) );
         httpContext.wjLocDisableFrm = (byte)(1) ;
      }
   ...
   public void checkOptimisticConcurrency088( )
   {
      if ( ! isIns( ) )
      {
         ...
         {
            httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_lock", new Object[] {"PublicidadApp"}), "RecordIsLocked", 1, "");
            AnyError = (short)(1) ;
            return  ;
         }
         Gx_longc = false ;
         ...
         if ( Gx_longc || ( Z190PublicidadMostrarApp != T00082_A190PublicidadMostrarApp[0] ) || ( Z191PublicidadMostrarWeb != T00082_A191PublicidadMostrarWeb[0] ) )
         {
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadTitulo");
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadSubTitulo");
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadDescripcion");
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadMenuApp");
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadMenuWeb");
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadMostrarApp");
            ...
            {
               GXutil.writeLogln("publicidadapp:[seudo value changed for attri]"+"PublicidadMostrarWeb");
               GXutil.writeLogRaw("Old: ",Z191PublicidadMostrarWeb);
               GXutil.writeLogRaw("Current: ",T00082_A191PublicidadMostrarWeb[0]);
            }
            httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_waschg", new Object[] {"PublicidadApp"}), "RecordWasChanged", 1, "");
            AnyError = (short)(1) ;
            return  ;
         }
      }
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               {
                  /* Using cursor T00088 */
                  pr_default.execute(6, new Object[] {Long.valueOf(A183PublicidadId), A184PublicidadTitulo, A185PublicidadSubTitulo, A186PublicidadDescripcion, A187PublicidadImagen, A40000PublicidadImagen_GXI, Boolean.valueOf(A188PublicidadMenuApp), Boolean.valueOf(A189PublicidadMenuWeb), Boolean.valueOf(A190PublicidadMostrarApp), Boolean.valueOf(A191PublicidadMostrarWeb)});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("PublicidadApp");
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               {
                  /* Using cursor T00089 */
                  pr_default.execute(7, new Object[] {A184PublicidadTitulo, A185PublicidadSubTitulo, A186PublicidadDescripcion, Boolean.valueOf(A188PublicidadMenuApp), Boolean.valueOf(A189PublicidadMenuWeb), Boolean.valueOf(A190PublicidadMostrarApp), Boolean.valueOf(A191PublicidadMostrarWeb), Long.valueOf(A183PublicidadId)});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("PublicidadApp");
   ...
   public void deferredUpdate088( )
   {
      if ( AnyError == 0 )
      {
         ...
         pr_default.execute(8, new Object[] {A187PublicidadImagen, A40000PublicidadImagen_GXI, Long.valueOf(A183PublicidadId)});
         Application.getSmartCacheProvider(remoteHandle).setUpdated("PublicidadApp");
      }
   }
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               pr_default.execute(9, new Object[] {Long.valueOf(A183PublicidadId)});
               Application.getSmartCacheProvider(remoteHandle).setUpdated("PublicidadApp");
               if ( AnyError == 0 )
               {
   ...
   public void endLevel088( )
   {
      ...
      if ( AnyError == 0 )
      {
         Application.commitDataStores(context, remoteHandle, pr_default, "publicidadapp");
         if ( AnyError == 0 )
         {
            confirmValues080( ) ;
         }
      ...
      {
         Application.rollbackDataStores(context, remoteHandle, pr_default, "publicidadapp");
      }
      IsModified = (short)(0) ;
      if ( AnyError != 0 )
      {
   ...
   public void scanStart088( )
   {
      ...
      {
         RcdFound8 = (short)(1) ;
         A183PublicidadId = T000812_A183PublicidadId[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A183PublicidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A183PublicidadId), 18, 0));
      }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202212311661638", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      GXutil.writeLogInfo("publicidadapp:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   {
      return formatLink("com.colaveco.publicidadapp", new String[] {GXutil.URLEncode(GXutil.rtrim(Gx_mode)),GXutil.URLEncode(GXutil.ltrimstr(AV7PublicidadId,18,0))}, new String[] {"Gx_mode","PublicidadId"})  ;
   }

   public String getPgmname( )
   {
      return "PublicidadApp" ;
   }

   public String getPgmdesc( )
   {
      return "Publicidad App" ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202212311661650", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("publicidadapp.js", "?202212311661650", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Publicidad App" );
      bttBtn_delete_Enabled = 0 ;
   ...
   public void initialize( )
   {
      ...
      T000812_A183PublicidadId = new long[1] ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      GXCCtlgxBlob = "" ;
      pr_gam = new DataStoreProvider(context, remoteHandle, new com.colaveco.publicidadapp__gam(),
         new Object[] {
         }
      );
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.publicidadapp__default(),
         new Object[] {
             new Object[] {
            T00082_A183PublicidadId, T00082_A184PublicidadTitulo, T00082_A185PublicidadSubTitulo, T00082_A186PublicidadDescripcion, T00082_A187PublicidadImagen, T00082_A40000PublicidadImagen_GXI, T00082_A188PublicidadMenuApp, T00082_A189PublicidadMenuWeb, T00082_A190PublicidadMostrarApp, T00082_A191PublicidadMostrarWeb
            }
            , new Object[] {
            T00083_A183PublicidadId, T00083_A184PublicidadTitulo, T00083_A185PublicidadSubTitulo, T00083_A186PublicidadDescripcion, T00083_A187PublicidadImagen, T00083_A40000PublicidadImagen_GXI, T00083_A188PublicidadMenuApp, T00083_A189PublicidadMenuWeb, T00083_A190PublicidadMostrarApp, T00083_A191PublicidadMostrarWeb
            }
            , new Object[] {
            T00084_A183PublicidadId, T00084_A184PublicidadTitulo, T00084_A185PublicidadSubTitulo, T00084_A186PublicidadDescripcion, T00084_A187PublicidadImagen, T00084_A40000PublicidadImagen_GXI, T00084_A188PublicidadMenuApp, T00084_A189PublicidadMenuWeb, T00084_A190PublicidadMostrarApp, T00084_A191PublicidadMostrarWeb
            }
            , new Object[] {
   ...
   private long[] T000812_A183PublicidadId ;
   private IDataStoreProvider pr_gam ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.colaveco.SdtTransactionContext AV9TrnContext ;
}

final  class publicidadapp__gam extends DataStoreHelperBase implements ILocalDataStoreHelper
{
...
final  class publicidadapp__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("T00082", "SELECT `PublicidadId`, `PublicidadTitulo`, `PublicidadSubTitulo`, `PublicidadDescripcion`, `PublicidadImagen`, `PublicidadImagen_GXI`, `PublicidadMenuApp`, `PublicidadMenuWeb`, `PublicidadMostrarApp`, `PublicidadMostrarWeb` FROM `PublicidadApp` WHERE `PublicidadId` = ?  FOR UPDATE ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00083", "SELECT `PublicidadId`, `PublicidadTitulo`, `PublicidadSubTitulo`, `PublicidadDescripcion`, `PublicidadImagen`, `PublicidadImagen_GXI`, `PublicidadMenuApp`, `PublicidadMenuWeb`, `PublicidadMostrarApp`, `PublicidadMostrarWeb` FROM `PublicidadApp` WHERE `PublicidadId` = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00084", "SELECT TM1.`PublicidadId`, TM1.`PublicidadTitulo`, TM1.`PublicidadSubTitulo`, TM1.`PublicidadDescripcion`, TM1.`PublicidadImagen`, TM1.`PublicidadImagen_GXI`, TM1.`PublicidadMenuApp`, TM1.`PublicidadMenuWeb`, TM1.`PublicidadMostrarApp`, TM1.`PublicidadMostrarWeb` FROM `PublicidadApp` TM1 WHERE TM1.`PublicidadId` = ? ORDER BY TM1.`PublicidadId` ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00085", "SELECT `PublicidadId` FROM `PublicidadApp` WHERE `PublicidadId` = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00086", "SELECT `PublicidadId` FROM `PublicidadApp` WHERE ( `PublicidadId` > ?) ORDER BY `PublicidadId`  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("T00087", "SELECT `PublicidadId` FROM `PublicidadApp` WHERE ( `PublicidadId` < ?) ORDER BY `PublicidadId` DESC  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new UpdateCursor("T00088", "INSERT INTO `PublicidadApp`(`PublicidadId`, `PublicidadTitulo`, `PublicidadSubTitulo`, `PublicidadDescripcion`, `PublicidadImagen`, `PublicidadImagen_GXI`, `PublicidadMenuApp`, `PublicidadMenuWeb`, `PublicidadMostrarApp`, `PublicidadMostrarWeb`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", GX_NOMASK)
         ,new UpdateCursor("T00089", "UPDATE `PublicidadApp` SET `PublicidadTitulo`=?, `PublicidadSubTitulo`=?, `PublicidadDescripcion`=?, `PublicidadMenuApp`=?, `PublicidadMenuWeb`=?, `PublicidadMostrarApp`=?, `PublicidadMostrarWeb`=?  WHERE `PublicidadId` = ?", GX_NOMASK)
         ,new UpdateCursor("T000810", "UPDATE `PublicidadApp` SET `PublicidadImagen`=?, `PublicidadImagen_GXI`=?  WHERE `PublicidadId` = ?", GX_NOMASK)
         ,new UpdateCursor("T000811", "DELETE FROM `PublicidadApp`  WHERE `PublicidadId` = ?", GX_NOMASK)
         ,new ForEachCursor("T000812", "SELECT `PublicidadId` FROM `PublicidadApp` ORDER BY `PublicidadId` ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[3])[0] = rslt.getString(4, 256);
                              ...
                              Object[] parms ) throws SQLException
   {
      switch ( cursor )
      {
            ...
            case 6 :
               ...
               stmt.setString(3, (String)parms[2], 256);
               stmt.setString(4, (String)parms[3], 256);
               stmt.setBLOBFile(5, (String)parms[4], true);
               stmt.setGXDbFileURI(6, (String)parms[5], (String)parms[4], 2048,"PublicidadApp","PublicidadImagen");
            ...
            case 8 :
               ...
               stmt.setGXDbFileURI(2, (String)parms[1], (String)parms[0], 2048,"PublicidadApp","PublicidadImagen");
