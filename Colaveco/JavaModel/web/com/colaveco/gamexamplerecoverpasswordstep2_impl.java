...
public final  class gamexamplerecoverpasswordstep2_impl extends GXWebPanel
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "AV18IDP_State", AV18IDP_State);
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vKEYTOCHANGEPASSWORD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9KeyToChangePassword, ""))));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2023126151100", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.colaveco.gamexamplerecoverpasswordstep2", new String[] {GXutil.URLEncode(GXutil.rtrim(AV18IDP_State)),GXutil.URLEncode(GXutil.rtrim(AV9KeyToChangePassword))}, new String[] {"IDP_State","KeyToChangePassword"}) +"\">") ;
   ...
   {
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERAUTHTYPENAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13UserAuthTypeName, ""))));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vKEYTOCHANGEPASSWORD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9KeyToChangePassword, ""))));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERREMEMBERME", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV17UserRememberMe), "Z9")));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vUSERAUTHTYPENAME", GXutil.rtrim( AV13UserAuthTypeName));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERAUTHTYPENAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13UserAuthTypeName, ""))));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vKEYTOCHANGEPASSWORD", GXutil.rtrim( AV9KeyToChangePassword));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vKEYTOCHANGEPASSWORD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9KeyToChangePassword, ""))));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vUSERREMEMBERME", GXutil.ltrim( localUtil.ntoc( AV17UserRememberMe, (byte)(2), (byte)(0), ".", "")));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERREMEMBERME", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV17UserRememberMe), "Z9")));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vIDP_STATE", GXutil.rtrim( AV18IDP_State));
   }
   ...
   public void wb0N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, divTable3_Internalname, 1, 0, "px", 0, "px", "LoginContainer", "left", "top", "", "", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-lg-10", "Center", "top", "", "", "div");
         ...
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 col-sm-offset-4", "left", "top", "", "", "div");
         /* Div Control */
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "RECOVER", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BigTitle", 0, "", 1, 1, 0, (short)(0), "HLP_GAMExampleRecoverPasswordStep2.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.colaveco.GxWebStd.gx_single_line_edit( httpContext, edtavUserpasswordnew_Internalname, GXutil.rtrim( AV15UserPasswordNew), GXutil.rtrim( localUtil.format( AV15UserPasswordNew, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,23);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "New Password", edtavUserpasswordnew_Jsonclick, 0, "LoginAttribute", "", "", "", "", 1, edtavUserpasswordnew_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(-1), (short)(0), 0, (byte)(1), (byte)(0), (byte)(0), true, "GeneXusSecurityCommon\\GAMPassword", "left", true, "", "HLP_GAMExampleRecoverPasswordStep2.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.colaveco.GxWebStd.gx_single_line_edit( httpContext, edtavUserpasswordnewconf_Internalname, GXutil.rtrim( AV16UserPasswordNewConf), GXutil.rtrim( localUtil.format( AV16UserPasswordNewConf, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Confirm Password", edtavUserpasswordnewconf_Jsonclick, 0, "LoginAttribute", "", "", "", "", 1, edtavUserpasswordnewconf_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(-1), (short)(0), 0, (byte)(1), (byte)(0), (byte)(0), true, "GeneXusSecurityCommon\\GAMPassword", "left", true, "", "HLP_GAMExampleRecoverPasswordStep2.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttEnter_Internalname, "", "Confirm", bttEnter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GAMExampleRecoverPasswordStep2.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, divTable2_Internalname, 1, 0, "px", 0, "px", "TableButtons", "left", "top", "", "", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.colaveco.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblTextblock2_Internalname, "BACK TO LOGIN", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'LOGIN\\'."+"'", "", "PagingText TextLikeLink", 5, "", 1, 1, 0, (short)(0), "HLP_GAMExampleRecoverPasswordStep2.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( GXutil.strcmp(AV15UserPasswordNew, AV16UserPasswordNewConf) == 0 )
      {
         ...
         if ( AV8Errors.size() == 0 )
         {
            ...
            if ( AV6ChangePwdOK )
            {
               ...
               AV5AdditionalParameter.setgxTv_SdtGAMLoginAdditionalParameters_Idpstate( AV18IDP_State );
               GXv_objcol_SdtGAMError1[0] = AV8Errors ;
               ...
               if ( AV10LoginOK )
               {
                  if ( new genexus.security.api.genexussecurity.SdtGAMRepository(remoteHandle, context).isremoteauthentication(AV18IDP_State) )
                  {
                     new genexus.security.api.genexussecurity.SdtGAMRepository(remoteHandle, context).redirecttoremoteauthentication(AV18IDP_State) ;
                  }
                  else
                  {
   ...
   public void e120N2( )
   {
      ...
      if ( new genexus.security.api.genexussecurity.SdtGAMRepository(remoteHandle, context).isremoteauthentication(AV18IDP_State) )
      {
         callWebObject(formatLink("com.colaveco.gamremotelogin", new String[] {GXutil.URLEncode(GXutil.rtrim(AV18IDP_State))}, new String[] {"IDP_State"}) );
         httpContext.wjLocDisableFrm = (byte)(1) ;
      }
      else
      {
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      AV21GXV1 = 1 ;
      while ( AV21GXV1 <= AV8Errors.size() )
      {
         AV7Error = (genexus.security.api.genexussecurity.SdtGAMError)((genexus.security.api.genexussecurity.SdtGAMError)AV8Errors.elementAt(-1+AV21GXV1));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2023126151278", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gamexamplerecoverpasswordstep2.js", "?20231261512722", false, true);
   ...
   public void initialize( )
   {
      ...
      pr_gam = new DataStoreProvider(context, remoteHandle, new com.colaveco.gamexamplerecoverpasswordstep2__gam(),
         new Object[] {
         }
      );
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.gamexamplerecoverpasswordstep2__default(),
         new Object[] {
         }
      );
      /* GeneXus formulas. */
