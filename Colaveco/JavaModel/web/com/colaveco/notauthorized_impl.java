...
public final  class notauthorized_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2023126152125", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.colaveco.notauthorized", new String[] {GXutil.URLEncode(GXutil.rtrim(GxObject))}, new String[] {"GxObject"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vGXOBJECT", GxObject);
   }
   ...
   public void renderHtmlContent( )
   {
      ...
      if ( ( gxajaxcallmode == 0 ) && ( GxWebError == 0 ) )
      {
         ...
         com.colaveco.GxWebStd.classAttribute( httpContext, "gx-ct-body"+" "+((GXutil.strcmp("", Form.getThemeClass())==0) ? "Form" : Form.getThemeClass())+"-fx");
   ...
   {
      return formatLink("com.colaveco.notauthorized", new String[] {GXutil.URLEncode(GXutil.rtrim(GxObject))}, new String[] {"GxObject"})  ;
   }
   ...
   public void wb0S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         {
            /* WebComponent */
            com.colaveco.GxWebStd.gx_hidden_field( httpContext, "W0002"+"", GXutil.rtrim( WebComp_Headerbc_Component));
            httpContext.writeText( "<div") ;
         ...
         {
            /* WebComponent */
            com.colaveco.GxWebStd.gx_hidden_field( httpContext, "W0003"+"", GXutil.rtrim( WebComp_Recentlinks_Component));
            httpContext.writeText( "<div") ;
            com.colaveco.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void wb_table1_4_0S2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_13_0S2( true) ;
      }
      else
      {
         wb_table2_13_0S2( false) ;
      }
      return  ;
   }

   public void wb_table2_13_0S2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table3_16_0S2( true) ;
      }
      else
      {
         wb_table3_16_0S2( false) ;
      }
      return  ;
   }

   public void wb_table3_16_0S2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     if ( nCmpId == 2 )
                     {
                        ...
                        {
                           WebComp_Headerbc = WebUtils.getWebComponent(getClass(), "com.colaveco." + OldHeaderbc + "_impl", remoteHandle, context);
                     ...
                     else if ( nCmpId == 3 )
                     {
                        ...
                        {
                           WebComp_Recentlinks = WebUtils.getWebComponent(getClass(), "com.colaveco." + OldRecentlinks + "_impl", remoteHandle, context);
   ...
   public void e110S2( )
   {
      ...
      {
         WebComp_Recentlinks = WebUtils.getWebComponent(getClass(), "com.colaveco.recentlinks_impl", remoteHandle, context);
   ...
   public void wb_table3_16_0S2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.colaveco.GxWebStd.gx_table_start( httpContext, tblTable3_Internalname, tblTable3_Internalname, "", "TableHorizontalLine", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         wb_table3_16_0S2e( true) ;
      }
      else
      {
         wb_table3_16_0S2e( false) ;
      }
   }

   public void wb_table2_13_0S2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.colaveco.GxWebStd.gx_table_start( httpContext, tblTable2_Internalname, tblTable2_Internalname, "", "HorizontalSpace", 0, "", "", 1, 2, sStyleString, "", "", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_13_0S2e( true) ;
      }
      else
      {
         wb_table2_13_0S2e( false) ;
      }
   }

   public void wb_table1_4_0S2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.colaveco.GxWebStd.gx_table_start( httpContext, tblTable1_Internalname, tblTable1_Internalname, "", "ViewTable", 0, "", "", 1, 2, sStyleString, "", "", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td colspan=\"2\" >") ;
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Not Authorized", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_NotAuthorized.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td colspan=\"2\" >") ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20231261521218", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("notauthorized.js", "?20231261521219", false, true);
