...
public final  class SdtTransactionContext extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Attributes") )
            {
               ...
               {
                  gxTv_SdtTransactionContext_Attributes = new GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute>(com.colaveco.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "Colaveco", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute> getgxTv_SdtTransactionContext_Attributes( )
   {
      if ( gxTv_SdtTransactionContext_Attributes == null )
      {
         gxTv_SdtTransactionContext_Attributes = new GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute>(com.colaveco.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "Colaveco", remoteHandle);
   ...
   public void setgxTv_SdtTransactionContext_Attributes( GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute> value )
   {
      gxTv_SdtTransactionContext_Attributes_N = (byte)(0) ;
      gxTv_SdtTransactionContext_N = (byte)(0) ;
   ...
   public com.colaveco.SdtTransactionContext Clone( )
   {
      return (com.colaveco.SdtTransactionContext)(clone()) ;
   }

   public void setStruct( com.colaveco.StructSdtTransactionContext struct )
   {
      ...
      GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux = new GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute>(com.colaveco.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "Colaveco", remoteHandle);
      Vector<com.colaveco.StructSdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux1 = struct.getAttributes();
      if (gxTv_SdtTransactionContext_Attributes_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtTransactionContext_Attributes_aux1.size(); i++)
         {
            gxTv_SdtTransactionContext_Attributes_aux.add(new com.colaveco.SdtTransactionContext_Attribute(gxTv_SdtTransactionContext_Attributes_aux1.elementAt(i)));
         }
      }
   ...
   public com.colaveco.StructSdtTransactionContext getStruct( )
   {
      com.colaveco.StructSdtTransactionContext struct = new com.colaveco.StructSdtTransactionContext ();
   ...
   protected GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux ;
   protected GXBaseCollection<com.colaveco.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes=null ;
}
