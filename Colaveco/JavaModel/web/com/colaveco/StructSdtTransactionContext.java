...
public final  class StructSdtTransactionContext implements Cloneable, java.io.Serializable
{
   ...
   {
      this( -1, new ModelContext( StructSdtTransactionContext.class ));
   }

   public StructSdtTransactionContext( int remoteHandle ,
   ...
   public java.util.Vector<com.colaveco.StructSdtTransactionContext_Attribute> getAttributes( )
   {
      return gxTv_SdtTransactionContext_Attributes ;
   }

   public void setAttributes( java.util.Vector<com.colaveco.StructSdtTransactionContext_Attribute> value )
   {
   ...
   protected java.util.Vector<com.colaveco.StructSdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes=null ;
}
