...
public final  class gamexamplessologin_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20231261521361", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.colaveco.gamexamplessologin", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void wb0Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_6_0Q2( true) ;
      }
      else
      {
         wb_table1_6_0Q2( false) ;
      }
      return  ;
   }

   public void wb_table1_6_0Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "<font>") ;
   ...
   public void wb_table1_6_0Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         com.colaveco.GxWebStd.gx_table_start( httpContext, tblTable1_Internalname, tblTable1_Internalname, "", "Table", 0, "", "", 0, 0, sStyleString, "", "", 0);
         ...
         httpContext.writeText( "<td data-align=\"center\"  style=\""+GXutil.CssPrettify( "text-align:-khtml-center;text-align:-moz-center;text-align:-webkit-center")+"\">") ;
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblTbback_Internalname, "Back", "", "", lblTbback_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "font-family:'Microsoft Sans Serif'; font-size:12.0pt; font-weight:normal; font-style:normal; text-decoration:underline; color:#000080;", "", 0, "", 1, 1, 0, (short)(0), "HLP_GAMExampleSSOLogin.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_6_0Q2e( true) ;
      }
      else
      {
         wb_table1_6_0Q2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20231261522987", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("gamexamplessologin.js", "?20231261522997", false, true);
      }
