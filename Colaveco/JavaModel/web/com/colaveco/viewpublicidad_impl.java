...
public final  class viewpublicidad_impl extends GXDataArea
{
   public viewpublicidad_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewpublicidad_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewpublicidad_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202311211554233", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"ViewPublicidad");
      ...
      GXutil.writeLogInfo("viewpublicidad:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   {
      return formatLink("com.colaveco.viewpublicidad", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12PublicidadId,18,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"PublicidadId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ViewPublicidad" ;
   }
   ...
   public void wb0Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Publicidad Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_ViewPublicidad.htm");
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Publicidads", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, (short)(0), "HLP_ViewPublicidad.htm");
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_html_textarea( httpContext, edtPublicidadTitulo_Internalname, GXutil.rtrim( A184PublicidadTitulo), "", "", (short)(0), 1, edtPublicidadTitulo_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "256", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_ViewPublicidad.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ViewPublicidad.htm");
         /* Div Control */
   ...
   public void start0Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Publicidad", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup0Y0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         {
            GXutil.writeLogError("viewpublicidad:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e110Y2( )
   {
      ...
      while ( (pr_default.getStatus(1) != 101) )
      {
         ...
         lblViewall_Link = formatLink("com.colaveco.wwpublicidad", new String[] {}, new String[] {})  ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV7SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV7SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "PublicidadGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.colaveco.publicidadgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PublicidadGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202311211554272", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewpublicidad.js", "?202311211554272", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View Publicidad" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.viewpublicidad__default(),
         new Object[] {
             new Object[] {
...
final  class viewpublicidad__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000Y2", "SELECT `PublicidadId`, `PublicidadTitulo` FROM `Publicidad` WHERE `PublicidadId` = ? ORDER BY `PublicidadId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H000Y3", "SELECT `PublicidadId`, `PublicidadTitulo` FROM `Publicidad` WHERE `PublicidadId` = ? ORDER BY `PublicidadId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
