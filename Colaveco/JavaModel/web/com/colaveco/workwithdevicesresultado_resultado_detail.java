...
public final  class workwithdevicesresultado_resultado_detail extends GXProcedure
{
...
final  class workwithdevicesresultado_resultado_detail__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00002", "SELECT `resultadoId`, `resultadoFicha` FROM `Resultado` WHERE `resultadoId` = ? ORDER BY `resultadoId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
