...
public final  class SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   public SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item( StructSdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item struct )
   {
      this();
      setStruct(struct);
   }
   ...
   public void setStruct( com.colaveco.StructSdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item struct )
   {
      GXBaseCollection<com.colaveco.SdtSDTTipoinforme_SDTTipoinformeItem> gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux = new GXBaseCollection<com.colaveco.SdtSDTTipoinforme_SDTTipoinformeItem>(com.colaveco.SdtSDTTipoinforme_SDTTipoinformeItem.class, "SDTTipoinformeItem", "Colaveco", remoteHandle);
      Vector<com.colaveco.StructSdtSDTTipoinforme_SDTTipoinformeItem> gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux1 = struct.getTipoinformelist();
      if (gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux1.size(); i++)
         {
            gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux.add(new com.colaveco.SdtSDTTipoinforme_SDTTipoinformeItem(gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux1.elementAt(i)));
         }
      }
      setgxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist(gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux);
   }

   @SuppressWarnings("unchecked")
   public com.colaveco.StructSdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item getStruct( )
   {
      com.colaveco.StructSdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item struct = new com.colaveco.StructSdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item ();
      struct.setTipoinformelist(getgxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist().getStruct());
      return struct ;
   }
   ...
   protected GXBaseCollection<com.colaveco.SdtSDTTipoinforme_SDTTipoinformeItem> gxTv_SdtTipoinformeFiltro_Level_Detail_Grid1Sdt_Item_Tipoinformelist_aux ;
