...
public final  class SdtTipoinformeFiltro_Level_DetailSdt extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   public SdtTipoinformeFiltro_Level_DetailSdt( StructSdtTipoinformeFiltro_Level_DetailSdt struct )
   {
      this();
      setStruct(struct);
   }
   ...
   public void setStruct( com.colaveco.StructSdtTipoinformeFiltro_Level_DetailSdt struct )
   {
   }

   @SuppressWarnings("unchecked")
   public com.colaveco.StructSdtTipoinformeFiltro_Level_DetailSdt getStruct( )
   {
      com.colaveco.StructSdtTipoinformeFiltro_Level_DetailSdt struct = new com.colaveco.StructSdtTipoinformeFiltro_Level_DetailSdt ();
      return struct ;
   }
