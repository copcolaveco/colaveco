...
public final  class viewanuncio_impl extends GXDataArea
{
   public viewanuncio_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewanuncio_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewanuncio_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV12AnuncioId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12AnuncioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12AnuncioId), 18, 0));
            com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vANUNCIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12AnuncioId), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20231261524336", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.colaveco.viewanuncio", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12AnuncioId,18,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"AnuncioId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"ViewAnuncio");
      forbiddenHiddens.add("AnuncioTitulo", GXutil.rtrim( localUtil.format( A193AnuncioTitulo, "")));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "hsh", httpContext.getEncryptedSignature( forbiddenHiddens.toString(), GXKey));
      GXutil.writeLogInfo("viewanuncio:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "vANUNCIOID", GXutil.ltrim( localUtil.ntoc( AV12AnuncioId, (byte)(18), (byte)(0), ".", "")));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vANUNCIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12AnuncioId), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.colaveco.viewanuncio", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12AnuncioId,18,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"AnuncioId","TabCode"})  ;
   }
   ...
   public void wb120( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Anuncio Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_ViewAnuncio.htm");
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Anuncios", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, (short)(0), "HLP_ViewAnuncio.htm");
         ...
         /* Single line edit */
         com.colaveco.GxWebStd.gx_single_line_edit( httpContext, edtAnuncioTitulo_Internalname, A193AnuncioTitulo, GXutil.rtrim( localUtil.format( A193AnuncioTitulo, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAnuncioTitulo_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtAnuncioTitulo_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_ViewAnuncio.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.colaveco.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ViewAnuncio.htm");
         /* Div Control */
   ...
   public void start122( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Anuncio", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf122( )
   {
      ...
      {
         /* Using cursor H00122 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV12AnuncioId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A192AnuncioId = H00122_A192AnuncioId[0] ;
            A193AnuncioTitulo = H00122_A193AnuncioTitulo[0] ;
   ...
   public void strup120( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV12AnuncioId = localUtil.ctol( httpContext.cgiGet( "vANUNCIOID"), ".", ",") ;
         ...
         {
            GXutil.writeLogError("viewanuncio:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e11122( )
   {
      ...
      AV16GXLvl6 = (byte)(0) ;
      /* Using cursor H00123 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV12AnuncioId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A192AnuncioId = H00123_A192AnuncioId[0] ;
         A193AnuncioTitulo = H00123_A193AnuncioTitulo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A193AnuncioTitulo", A193AnuncioTitulo);
         AV16GXLvl6 = (byte)(1) ;
         Form.setCaption( A193AnuncioTitulo );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.colaveco.wwanuncio", new String[] {}, new String[] {})  ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV7SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV7SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "AnuncioGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.colaveco.anunciogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "AnuncioGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0030","",Long.valueOf(AV12AnuncioId)});
   ...
   {
      AV12AnuncioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12AnuncioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12AnuncioId), 18, 0));
      com.colaveco.GxWebStd.gx_hidden_field( httpContext, "gxhash_vANUNCIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12AnuncioId), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20231261524388", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewanuncio.js", "?20231261524388", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12AnuncioId',fld:'vANUNCIOID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A193AnuncioTitulo',fld:'ANUNCIOTITULO',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H00122_A192AnuncioId = new long[1] ;
      H00122_A193AnuncioTitulo = new String[] {""} ;
      hsh = "" ;
      H00123_A192AnuncioId = new long[1] ;
      H00123_A193AnuncioTitulo = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.viewanuncio__default(),
         new Object[] {
             new Object[] {
            H00122_A192AnuncioId, H00122_A193AnuncioTitulo
            }
            , new Object[] {
            H00123_A192AnuncioId, H00123_A193AnuncioTitulo
            }
         }
      );
      AV15Pgmname = "ViewAnuncio" ;
   ...
   private int idxLst ;
   private long wcpOAV12AnuncioId ;
   private long AV12AnuncioId ;
   ...
   private long[] H00122_A192AnuncioId ;
   private String[] H00122_A193AnuncioTitulo ;
   private long[] H00123_A192AnuncioId ;
   private String[] H00123_A193AnuncioTitulo ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewanuncio__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00122", "SELECT `AnuncioId`, `AnuncioTitulo` FROM `Anuncio` WHERE `AnuncioId` = ? ORDER BY `AnuncioId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00123", "SELECT `AnuncioId`, `AnuncioTitulo` FROM `Anuncio` WHERE `AnuncioId` = ? ORDER BY `AnuncioId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
