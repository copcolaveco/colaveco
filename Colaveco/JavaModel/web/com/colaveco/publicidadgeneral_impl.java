...
public final  class publicidadgeneral_impl extends GXWebComponent
{
   public publicidadgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public publicidadgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( publicidadgeneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Publicidad General") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202311211554058", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void wb100( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.colaveco.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.colaveco.publicidadgeneral");
         }
         ...
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11101_client"+"'", TempTags, "", 2, "HLP_PublicidadGeneral.htm");
         ...
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12101_client"+"'", TempTags, "", 2, "HLP_PublicidadGeneral.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_html_textarea( httpContext, edtPublicidadTitulo_Internalname, GXutil.rtrim( A184PublicidadTitulo), "", "", (short)(0), 1, edtPublicidadTitulo_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "256", -1, 0, "", "", (byte)(-1), true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_PublicidadGeneral.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_html_textarea( httpContext, edtPublicidadSubTitulo_Internalname, GXutil.rtrim( A185PublicidadSubTitulo), "", "", (short)(0), 1, edtPublicidadSubTitulo_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "256", -1, 0, "", "", (byte)(-1), true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_PublicidadGeneral.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         com.colaveco.GxWebStd.gx_html_textarea( httpContext, edtPublicidadDescripcion_Internalname, GXutil.rtrim( A186PublicidadDescripcion), "", "", (short)(0), 1, edtPublicidadDescripcion_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "256", -1, 0, "", "", (byte)(-1), true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_PublicidadGeneral.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.colaveco.GxWebStd.gx_bitmap( httpContext, imgPublicidadImagen_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 0, "", "", 1, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A187PublicidadImagen_IsBlob, true, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_PublicidadGeneral.htm");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.colaveco.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start102( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Publicidad General", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf102( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            n187PublicidadImagen = H00102_n187PublicidadImagen[0] ;
            ...
            n40000PublicidadImagen_GXI = H00102_n40000PublicidadImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, imgPublicidadImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A187PublicidadImagen)==0) ? A40000PublicidadImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A187PublicidadImagen))), true);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, imgPublicidadImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A187PublicidadImagen), true);
            A191PublicidadMostrarWeb = H00102_A191PublicidadMostrarWeb[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A191PublicidadMostrarWeb", A191PublicidadMostrarWeb);
            A190PublicidadMostrarApp = H00102_A190PublicidadMostrarApp[0] ;
            n190PublicidadMostrarApp = H00102_n190PublicidadMostrarApp[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A190PublicidadMostrarApp", A190PublicidadMostrarApp);
            A189PublicidadMenuWeb = H00102_A189PublicidadMenuWeb[0] ;
            n189PublicidadMenuWeb = H00102_n189PublicidadMenuWeb[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A189PublicidadMenuWeb", A189PublicidadMenuWeb);
            A188PublicidadMenuApp = H00102_A188PublicidadMenuApp[0] ;
            n188PublicidadMenuApp = H00102_n188PublicidadMenuApp[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A188PublicidadMenuApp", A188PublicidadMenuApp);
            A186PublicidadDescripcion = H00102_A186PublicidadDescripcion[0] ;
            n186PublicidadDescripcion = H00102_n186PublicidadDescripcion[0] ;
            ...
            n185PublicidadSubTitulo = H00102_n185PublicidadSubTitulo[0] ;
   ...
   public void S112( )
   {
      ...
      AV7TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Publicidad" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "publicidadgeneral", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202311211554149", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("publicidadgeneral.js", "?202311211554150", false, true);
   ...
   public void initialize( )
   {
      ...
      H00102_n187PublicidadImagen = new boolean[] {false} ;
      H00102_A40000PublicidadImagen_GXI = new String[] {""} ;
      H00102_n40000PublicidadImagen_GXI = new boolean[] {false} ;
      H00102_A191PublicidadMostrarWeb = new boolean[] {false} ;
      H00102_A190PublicidadMostrarApp = new boolean[] {false} ;
      H00102_n190PublicidadMostrarApp = new boolean[] {false} ;
      H00102_A189PublicidadMenuWeb = new boolean[] {false} ;
      H00102_n189PublicidadMenuWeb = new boolean[] {false} ;
      H00102_A188PublicidadMenuApp = new boolean[] {false} ;
      H00102_n188PublicidadMenuApp = new boolean[] {false} ;
      H00102_A186PublicidadDescripcion = new String[] {""} ;
      H00102_n186PublicidadDescripcion = new boolean[] {false} ;
      H00102_A185PublicidadSubTitulo = new String[] {""} ;
      H00102_n185PublicidadSubTitulo = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.colaveco.publicidadgeneral__default(),
         new Object[] {
             new Object[] {
            H00102_A183PublicidadId, H00102_A187PublicidadImagen, H00102_n187PublicidadImagen, H00102_A40000PublicidadImagen_GXI, H00102_n40000PublicidadImagen_GXI, H00102_A191PublicidadMostrarWeb, H00102_A190PublicidadMostrarApp, H00102_n190PublicidadMostrarApp, H00102_A189PublicidadMenuWeb, H00102_n189PublicidadMenuWeb,
            H00102_A188PublicidadMenuApp, H00102_n188PublicidadMenuApp, H00102_A186PublicidadDescripcion, H00102_n186PublicidadDescripcion, H00102_A185PublicidadSubTitulo, H00102_n185PublicidadSubTitulo, H00102_A184PublicidadTitulo
            }
         }
      );
      AV13Pgmname = "PublicidadGeneral" ;
...
final  class publicidadgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00102", "SELECT `PublicidadId`, `PublicidadImagen`, `PublicidadImagen_GXI`, `PublicidadMostrarWeb`, `PublicidadMostrarApp`, `PublicidadMenuWeb`, `PublicidadMenuApp`, `PublicidadDescripcion`, `PublicidadSubTitulo`, `PublicidadTitulo` FROM `Publicidad` WHERE `PublicidadId` = ? ORDER BY `PublicidadId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[12])[0] = rslt.getString(8, 256);
               ((boolean[]) buf[13])[0] = rslt.wasNull();
               ((String[]) buf[14])[0] = rslt.getString(9, 256);
               ((boolean[]) buf[15])[0] = rslt.wasNull();
               ((String[]) buf[16])[0] = rslt.getString(10, 256);
               return;
      }
   }
