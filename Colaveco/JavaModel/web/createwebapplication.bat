...
xcopy log4j-api-2.16.0.jar %1\webapps\%2\WEB-INF\lib /Y /D
xcopy log4j-core-2.16.0.jar %1\webapps\%2\WEB-INF\lib /Y /D
xcopy log4j-1.2-api-2.16.0.jar %1\webapps\%2\WEB-INF\lib /Y /D
