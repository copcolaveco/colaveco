...
/**@preserve GeneXus 17.0.7.156407*/
	...
	return {
		...
		loadJsonGrids: function (PostGrids, isPostback) {
			...
			$.when.apply($, innerDeferreds).done(function() {
				...
				var updatedUCsObjs = updatedUCs.map( function( G) { 
					var Grid = gx.fn.gridObj(G.cmpCtx, G.gridName, G.inMasterPage); 
					if (Grid) 
						return Grid.grid
				});
				deferred.resolve(updatedUCsObjs);
			});
			return deferred;
	},
