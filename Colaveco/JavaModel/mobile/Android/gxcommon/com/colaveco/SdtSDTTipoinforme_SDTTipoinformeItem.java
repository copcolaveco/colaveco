/*
               File: SdtSDTTipoinforme_SDTTipoinformeItem
        Description: SDTTipoinforme
             Author: GeneXus Android Generator version 17_0_7-156546
       Generated on: November 14, 2022 7:39:32.12
...
public final  class SdtSDTTipoinforme_SDTTipoinformeItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   public void sdttoentity( IEntity androidEntity )
   {
      ...
      androidEntity.setProperty("SDTTipoinformeId", GXutil.trim( GXutil.str( gxTv_SdtSDTTipoinforme_SDTTipoinformeItem_Sdttipoinformeid, 18, 0)));
      androidEntity.setProperty("SDTTipoinformeNombre", GXutil.trim( gxTv_SdtSDTTipoinforme_SDTTipoinformeItem_Sdttipoinformenombre));
   }

   public void entitytosdt( IEntity androidEntity )
   {
      /*  Copy entity values to BC  */
      setgxTv_SdtSDTTipoinforme_SDTTipoinformeItem_Sdttipoinformeid( (long) GXutil.lval( androidEntity.optStringProperty("SDTTipoinformeId")));
      setgxTv_SdtSDTTipoinforme_SDTTipoinformeItem_Sdttipoinformenombre( (String) androidEntity.optStringProperty("SDTTipoinformeNombre"));
   }
